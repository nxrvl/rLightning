...
fn bench_parse_bulk_strings(c: &mut Criterion) {
    ...
    let medium_bulk = BytesMut::from(format!("${}\r\n{}\r\n", medium_data.len(), medium_data).as_str());
    ...
    let large_bulk = BytesMut::from(format!("${}\r\n{}\r\n", large_data.len(), large_data).as_str());
...
fn bench_parse_arrays(c: &mut Criterion) {
    ...
    // Nested array
    let nested_array = BytesMut::from(b"*2\r\n*2\r\n$3\r\nfoo\r\n$3\r\nbar\r\n*1\r\n$3\r\nbaz\r\n".as_slice());
    ...
    // Mixed type array
    let mixed_array = BytesMut::from(b"*4\r\n$3\r\nSET\r\n$3\r\nkey\r\n$5\r\nvalue\r\n:100\r\n".as_slice());
...
fn bench_parse_real_commands(c: &mut Criterion) {
    ...
    // MSET command
    let mset_cmd = BytesMut::from(b"*5\r\n$4\r\nMSET\r\n$4\r\nkey1\r\n$6\r\nvalue1\r\n$4\r\nkey2\r\n$6\r\nvalue2\r\n".as_slice());
    ...
    // HSET command
    let hset_cmd = BytesMut::from(b"*4\r\n$4\r\nHSET\r\n$6\r\nmyhash\r\n$5\r\nfield\r\n$5\r\nvalue\r\n".as_slice());
    ...
    // LPUSH command
    let lpush_cmd = BytesMut::from(b"*4\r\n$5\r\nLPUSH\r\n$6\r\nmylist\r\n$5\r\nitem1\r\n$5\r\nitem2\r\n".as_slice());
    ...
    // ZADD command
    let zadd_cmd = BytesMut::from(b"*4\r\n$4\r\nZADD\r\n$6\r\nmyzset\r\n$3\r\n1.5\r\n$6\r\nmember\r\n".as_slice());
