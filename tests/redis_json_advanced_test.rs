...
async fn test_redis_json_advanced() -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
    ...
    let result = client
        .send_command_str("JSON.SET", &["complex", ".", complex_json])
        .await?;
    assert_eq!(
        result,
        RespValue::SimpleString("OK".to_string()),
        "JSON.SET should return OK"
    );
    ...
    let result = client
        .send_command_str("JSON.GET", &["complex", "age"])
        .await?;
    ...
    let result = client
        .send_command_str("JSON.GET", &["complex", "name.first"])
        .await?;
    if let RespValue::BulkString(Some(bytes)) = result {
        let value = String::from_utf8(bytes)?;
    ...
    let result = client
        .send_command_str("JSON.GET", &["complex", "address.home.zipcode"])
        .await?;
    if let RespValue::BulkString(Some(bytes)) = result {
        let value = String::from_utf8(bytes)?;
    ...
    let result = client
        .send_command_str("JSON.GET", &["complex", "tags[0]"])
        .await?;
    if let RespValue::BulkString(Some(bytes)) = result {
        let value = String::from_utf8(bytes)?;
    ...
    // Get second tag
    let result = client
        .send_command_str("JSON.GET", &["complex", "tags[1]"])
        .await?;
    if let RespValue::BulkString(Some(bytes)) = result {
        let value = String::from_utf8(bytes)?;
    ...
    let result = client
        .send_command_str("JSON.GET", &["complex", "projects[0].name"])
        .await?;
    if let RespValue::BulkString(Some(bytes)) = result {
        let value = String::from_utf8(bytes)?;
        assert_eq!(
            value, r#""Project 1""#,
            "First project name should be Project 1"
        );
    } else {
    ...
    let result = client
        .send_command_str("JSON.GET", &["complex", "projects[1].priority"])
        .await?;
    if let RespValue::BulkString(Some(bytes)) = result {
        let value = String::from_utf8(bytes)?;
    ...
    let result = client
        .send_command_str("JSON.GET", &["complex", "tags"])
        .await?;
    if let RespValue::BulkString(Some(bytes)) = result {
        let value = String::from_utf8(bytes)?;
        assert!(
            value.contains("developer"),
            "tags array should contain developer"
        );
    } else {
    ...
    let result = client
        .send_command_str("JSON.GET", &["complex", "projects"])
        .await?;
    if let RespValue::BulkString(Some(bytes)) = result {
        let value = String::from_utf8(bytes)?;
        assert!(
            value.contains("Project 2"),
            "projects array should contain Project 2"
        );
    } else {
    ...
    let result = client
        .send_command_str("JSON.SET", &["another", ".", another_json])
        .await?;
    assert_eq!(
        result,
        RespValue::SimpleString("OK".to_string()),
    ...
    let result = client
        .send_command_str("JSON.MGET", &["complex", "another", "name.first"])
        .await?;
    ...
    let result = client
        .send_command_str("JSON.GET", &["complex", "address.home.city"])
        .await?;
    if let RespValue::BulkString(Some(bytes)) = result {
        let value = String::from_utf8(bytes)?;
    ...
    assert_eq!(
        result,
        RespValue::SimpleString("object".to_string()),
        "Root should be object type"
    );

    // Check type of string
    let result = client
        .send_command_str("JSON.TYPE", &["complex", "id"])
        .await?;
    assert_eq!(
        result,
    ...
    let result = client
        .send_command_str("JSON.TYPE", &["complex", "age"])
        .await?;
    assert_eq!(
        result,
        RespValue::SimpleString("number".to_string()),
        "age should be number type"
    );

    // Check type of boolean
    let result = client
        .send_command_str("JSON.TYPE", &["complex", "active"])
        .await?;
    assert_eq!(
        result,
        RespValue::SimpleString("boolean".to_string()),
        "active should be boolean type"
    );

    // Check type of array
    let result = client
        .send_command_str("JSON.TYPE", &["complex", "tags"])
        .await?;
    assert_eq!(
        result,
        RespValue::SimpleString("array".to_string()),
        "tags should be array type"
    );

    // Check type of nested object
    let result = client
        .send_command_str("JSON.TYPE", &["complex", "address"])
        .await?;
    assert_eq!(
        result,
        RespValue::SimpleString("object".to_string()),
    ...
    // Check type of null
    let result = client
        .send_command_str("JSON.TYPE", &["complex", "nullValue"])
        .await?;
    assert_eq!(
        result,
        RespValue::SimpleString("null".to_string()),
        "nullValue should be null type"
    );

    // Check type of empty object
    let result = client
        .send_command_str("JSON.TYPE", &["complex", "emptyObject"])
        .await?;
    assert_eq!(
        result,
        RespValue::SimpleString("object".to_string()),
        "emptyObject should be object type"
    );

    // Check type of empty array
    let result = client
        .send_command_str("JSON.TYPE", &["complex", "emptyArray"])
        .await?;
    assert_eq!(
        result,
        RespValue::SimpleString("array".to_string()),
        "emptyArray should be array type"
    );
    ...
    // Update string value
    let result = client
        .send_command_str("JSON.SET", &["complex", "id", r#""user456""#])
        .await?;
    assert_eq!(
        result,
        RespValue::SimpleString("OK".to_string()),
    ...
    let result = client
        .send_command_str("JSON.GET", &["complex", "id"])
        .await?;
    if let RespValue::BulkString(Some(bytes)) = result {
        let value = String::from_utf8(bytes)?;
    ...
    // Update number value
    let result = client
        .send_command_str("JSON.SET", &["complex", "age", "31"])
        .await?;
    assert_eq!(
        result,
        RespValue::SimpleString("OK".to_string()),
    ...
    let result = client
        .send_command_str("JSON.SET", &["complex", "active", "false"])
        .await?;
    assert_eq!(
        result,
        RespValue::SimpleString("OK".to_string()),
    ...
    // Update nested value
    let result = client
        .send_command_str("JSON.SET", &["complex", "name.first", r#""Jane""#])
        .await?;
    assert_eq!(
        result,
        RespValue::SimpleString("OK".to_string()),
    ...
    let result = client
        .send_command_str("JSON.SET", &["complex", "tags", updated_tags])
        .await?;
    assert_eq!(
        result,
        RespValue::SimpleString("OK".to_string()),
    ...
    if let RespValue::BulkString(Some(bytes)) = result {
        let value = String::from_utf8(bytes)?;
        assert!(
            value.contains("senior-developer"),
            "tags array should contain senior-developer"
        );
    }
    ...
    let result = client
        .send_command_str("JSON.SET", &["complex", "projects.1", updated_project])
        .await?;
    assert_eq!(
        result,
        RespValue::SimpleString("OK".to_string()),
    ...
    if let RespValue::BulkString(Some(bytes)) = &result {
        ...
        assert!(
            before_value.contains(r#"["senior-developer","rust","redis"]"#),
        ...
        let append_result = client
            .send_command_str(
                "JSON.ARRAPPEND",
                &["complex", "tags", r#""json""#, r#""database""#],
            )
            .await;
        ...
        if let Ok(RespValue::Integer(len)) = append_result {
            assert!(
                len >= 3,
                "ARRAPPEND should return the new array length (>= 3)"
            );
            ...
            if let RespValue::BulkString(Some(bytes)) = result {
                ...
                assert!(
                    after_value.contains("json"),
                    "tags should contain json after append"
                );
                assert!(
                    after_value.contains("database"),
                    "tags should contain database after append"
                );
            }
        } else {
    ...
    let result = client
        .send_command_str("JSON.ARRINDEX", &["complex", "tags", r#""rust""#])
        .await;
    match result {
        Ok(RespValue::Integer(idx)) => {
            ...
            let result = client
                .send_command_str("JSON.ARRINDEX", &["complex", "tags", r#""nonexistent""#])
                .await?;
            assert_eq!(
                result,
                RespValue::Integer(-1),
                "nonexistent item should return -1"
            );
        }
    ...
    println!(
        "Skipping JSON.ARRPOP, JSON.ARRINSERT, and JSON.ARRTRIM tests as they may not be implemented"
    );
    ...
    let result = client
        .send_command_str("JSON.SET", &["complex", "nullValue", "null"])
        .await?;
    assert_eq!(
        result,
        RespValue::SimpleString("OK".to_string()),
    ...
    if let RespValue::BulkString(Some(bytes)) = &result {
        ...
        assert!(
            json_str.contains("\"nullValue\":null") || !json_str.contains("nullValue"),
    ...
    let result = client
        .send_command_str("JSON.SET", &["complex", "projects", new_projects])
        .await?;
    assert_eq!(
        result,
        RespValue::SimpleString("OK".to_string()),
    ...
    if let RespValue::BulkString(Some(bytes)) = &result {
        let json_str = String::from_utf8(bytes.clone())?;
        assert!(
            !json_str.contains("Project 1"),
            "Project 1 should be deleted"
        );
        assert!(
            json_str.contains("Project 2"),
    ...
    let result = client
        .send_command_str("JSON.SET", &["complex", "address.work", "null"])
        .await?;
    assert_eq!(
        result,
        RespValue::SimpleString("OK".to_string()),
    ...
    let result = client
        .send_command_str("JSON.GET", &["complex", "address.work"])
        .await?;
    assert!(
    ...
    // Test invalid JSON
    let result = client
        .send_command_str("JSON.SET", &["invalid_json", ".", "not valid json"])
        .await?;
    assert!(
    ...
    // Test invalid path
    let result = client
        .send_command_str("JSON.GET", &["complex", "nonexistent.path"])
        .await?;
    assert_eq!(
        result,
        RespValue::BulkString(None),
        "Nonexistent path should return nil"
    );

    // Test incorrect array index
    let result = client
        .send_command_str("JSON.GET", &["complex", "tags[99]"])
        .await?;
    assert_eq!(
        result,
        RespValue::BulkString(None),
        "Invalid array index should return nil"
    );

    // Test wrong type operation
    // Try to get array length of non-array
    let result = client
        .send_command_str("JSON.ARRLEN", &["complex", "age"])
        .await?;
    assert!(
        matches!(result, RespValue::Error(_)) || result == RespValue::Integer(0),
    ...
    let result = client
        .send_command_str("JSON.NUMINCRBY", &["complex", "age", "5"])
        .await?;
    if let RespValue::BulkString(Some(bytes)) = result {
        let value = String::from_utf8(bytes)?;
    ...
    let result = client
        .send_command_str("JSON.NUMINCRBY", &["complex", "projects[0].priority", "10"])
        .await?;
    if let RespValue::BulkString(Some(bytes)) = result {
        let value = String::from_utf8(bytes)?;
    ...
    let result = client
        .send_command_str("JSON.NUMINCRBY", &["complex", "name.first", "5"])
        .await?;
    assert!(
        matches!(result, RespValue::Error(_)),
        "NUMINCRBY on non-number should return error"
    );
    ...
    let result = client
        .send_command_str(
            "JSON.SET",
            &["expiring_json", ".", r#"{"value":"temporary"}"#],
        )
        .await?;
    assert_eq!(
        result,
    ...
    // Set TTL
    let result = client
        .send_command_str("EXPIRE", &["expiring_json", "1"])
        .await?;
    ...
    // Verify key expired
    let result = client
        .send_command_str("JSON.GET", &["expiring_json"])
        .await?;
    ...
    let result = client
        .send_command_str("JSON.SET", &["large_nested", ".", &large_nested_json])
        .await?;
    assert_eq!(
        result,
        RespValue::SimpleString("OK".to_string()),
        "JSON.SET should return OK for large JSON"
    );
    ...
    let result = client
        .send_command_str(
            "JSON.GET",
            &["large_nested", "items.42.nested.level1.level2.level3.value"],
        )
        .await;
    match result {
        Ok(RespValue::BulkString(Some(bytes))) => {
            let value = String::from_utf8(bytes)?;
            assert!(
                value.contains("deep42"),
                "Deeply nested value should contain deep42"
            );
        }
    ...
    let result = client
        .send_command_str("JSON.GET", &["large_nested"])
        .await?;
    assert!(
        matches!(result, RespValue::BulkString(Some(_))),
        "Should be able to retrieve entire large document"
    );
