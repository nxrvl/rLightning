...
async fn test_redis_json_advanced() -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
    ...
    assert_eq!(
        result,
        RespValue::BulkString(Some(b"string".to_vec())),
    ...
    assert_eq!(
        result,
        RespValue::BulkString(Some(b"number".to_vec())),
    ...
    assert_eq!(
        result,
        RespValue::BulkString(Some(b"boolean".to_vec())),
    ...
    assert_eq!(
        result,
        RespValue::BulkString(Some(b"array".to_vec())),
